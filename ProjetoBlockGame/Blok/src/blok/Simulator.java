...
public class Simulator implements Runnable, ContactListener {
    ...
    public Simulator(GamePanel mainPanel) {
    ...
    public void removeBody(Body body) {
        ...
        {
            stop();
            m_mainPanel.setState(GamePanel.State.YOUWON);
        }
    }
    ...
    public void beginContact(Contact contact) {
        ...
        {
            stop();
            m_mainPanel.setState(GamePanel.State.YOULOST);
        }
    }
